...
<section class="projects-archive">
    <h2>Najnowsze Projekty (Wyciągnięte przez WP_Query)</h2>
            ...
            while ( $projects_query->have_posts() ) : $projects_query->the_post(); 
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class( 'project-card' ); ?>>
                    ...
                    <div class="project-meta">
                        ...
                        <?php if ( $github_url ) : ?>
                            <p><a href="<?php echo esc_url( $github_url ); ?>" target="_blank" rel="noopener">Zobacz Repozytorium GitHub &rarr;</a></p>
                        <?php endif; ?>
                    </div>
